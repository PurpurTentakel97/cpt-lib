...
if (PROJECT_IS_TOP_LEVEL)
    option(cpt_lib_enable_warnings_as_errors "Treat warnings as errors" ON)
    ...
    option(cpt_lib_enable_tests "Build tests using Google Test" ON)
else ()
    option(cpt_lib_enable_warnings_as_errors "Treat warnings as errors" OFF)
    ...
    option(cpt_lib_enable_tests "Build tests using Google Test" OFF)
endif ()

add_library(cpt_lib_warnings INTERFACE)
set_warnings(cpt_lib_warnings ${cpt_lib_enable_warnings_as_errors})
